...
#                     print("取tumor随机点坐标是：%d,%d"%(random_x,random_y))
        ...
        random_img01 = (random_img.convert("RGB")).rotate(np.random.random(1) * 360.)

        #***接下来就给他贴标签，并处理成训练所需的数据结构***#
        random_img_arr = array(random_img01)
        return random_img_arr/255.,1    # 注意要除以255.,做归一化处理
...
#                 print("非tumor区检测情况",len(random_img_x), (array(random_img.convert("RGB"))).std())
        ...
        #***接下来就给他贴标签，并处理成训练所需的数据结构***#
        random_img_arr = array(random_img01)
        return random_img_arr/255.,0    # 注意要除以255.,做归一化处理
